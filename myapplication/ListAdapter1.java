...
public class ListAdapter1 extends RecyclerView.Adapter<ListAdapter1.ItemViewHolder>
    ...
    @NonNull
    @Override
    public ListAdapter1.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBind(Person person) {
            ...
            list_age.setText(person.getAge());
            list_image.setImageResource(person.getImage());
            list_price.setText(person.getPrice());
        }
